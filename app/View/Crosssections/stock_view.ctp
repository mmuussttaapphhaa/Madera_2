<div class="crosssections view">
<h2><?php echo __('Crosssection'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($crosssection['Crosssection']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($crosssection['Crosssection']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Plan'); ?></dt>
		<dd>
			<?php echo h($crosssection['Crosssection']['plan']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Crosssection'), array('action' => 'edit', $crosssection['Crosssection']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Crosssection'), array('action' => 'delete', $crosssection['Crosssection']['id']), array(), __('Are you sure you want to delete # %s?', $crosssection['Crosssection']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Crosssections'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Crosssection'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($crosssection['Modele'])): ?>
	...
	<?php foreach ($crosssection['Modele'] as $modele): ?>
		<tr>
